  ...
  return (
    <section id="how-it-works" className="py-28 px-6 relative">
      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        >
          <span className="text-xs uppercase tracking-[0.2em] text-[#4F46E5] font-semibold">Hoe het werkt</span>
        ...
        <div className="relative">
          {/* Vertical line */}
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-[#4F46E5]/50 via-[#7C3AED]/50 to-transparent hidden md:block" />
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className={`flex-1 ${i % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                <span className="text-[#4F46E5] text-xs font-bold tracking-widest">{step.num}</span>
              ...
              <div className="relative z-10 flex-shrink-0">
                <div className="w-16 h-16 rounded-2xl bg-white border border-gray-200 shadow-sm flex items-center justify-center">
                  <step.icon className="h-7 w-7 text-[#4F46E5]" />
                </div>
              </div>
