    ...
    <section id="ai-showcase" className="py-28 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="glass rounded-3xl p-8 md:p-16 relative overflow-hidden glow-blue">
          ...
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#9cbb48]/5 rounded-full blur-[150px]" />
          <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#2c4080]/10 rounded-full blur-[120px]" />
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#9cbb48]/10 border border-[#9cbb48]/20 rounded-full text-sm text-[#9cbb48] mb-6">
              ...
              <div className="bg-[#0a0b14] rounded-2xl border border-white/10 overflow-hidden">
                ...
                <div className="p-6 h-80 overflow-hidden">
                  <p className="text-sm text-gray-300 whitespace-pre-wrap leading-relaxed font-mono">
                    {displayedText}
                    {isTyping && <span className="inline-block w-0.5 h-4 bg-[#9cbb48] ml-0.5 animate-pulse" />}
                  </p>
                </div>
              </div>
            </motion.div>
